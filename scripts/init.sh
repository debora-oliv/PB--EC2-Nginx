        	...
        	<section id="documentacao" class="home_apresentacao">
            		...
            		<div class="documentacao-container">
                		<p class="home_apresentacao_p documentacao-texto">
                    			A documentação detalhada do projeto está disponí­vel com todos os passos de implementação, configuração técnica e códigos utilizados. Explore para entender melhor a arquitetura e o funcionamento do sistema.
                		</p>
